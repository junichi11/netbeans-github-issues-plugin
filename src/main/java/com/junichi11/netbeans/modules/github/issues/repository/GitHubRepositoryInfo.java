...
public final class GitHubRepositoryInfo {
    ...
    public GitHubRepositoryInfo setUserName(String userName) {
        this.userName = userName;
        return this;
    }

    public GitHubRepositoryInfo setOAuthToken(String oauthToken) {
        this.oauthToken = oauthToken;
        return this;
    }

    public GitHubRepositoryInfo setPropertyFile(boolean isPropertyFile) {
        this.isPropertyFile = isPropertyFile;
        return this;
    }

    public GitHubRepositoryInfo setRepositoryAuthor(String repositoryAuthor) {
