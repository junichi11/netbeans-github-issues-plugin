...
public enum GitHubIssueState {
    ...
    private static final Map<String, GitHubIssueState> states = new HashMap<>();

    static {
        for (GitHubIssueState s : GitHubIssueState.values()) {
            states.put(s.toString(), s);
        }
    }

    private GitHubIssueState(String state) {
        this.state = state;
    }
