...
class GitHubAssignedToMeQuery extends GitHubDefaultQuery {

    public GitHubAssignedToMeQuery(GitHubRepository repository) {
        super(repository);
    }

    public GitHubAssignedToMeQuery(GitHubRepository repository, String name) {
        super(repository, name);
    }

    @Override
    @NbBundle.Messages({
        "GitHubAssignedToMeQuery.displayName=Assigned to me"
    })
    public String getDisplayName() {
        return Bundle.GitHubAssignedToMeQuery_displayName();
    }
