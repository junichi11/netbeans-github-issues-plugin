...
class GitHubCreatedByMeQuery extends GitHubDefaultQuery {

    public GitHubCreatedByMeQuery(GitHubRepository repository) {
        super(repository);
    }

    public GitHubCreatedByMeQuery(GitHubRepository repository, String name) {
        super(repository, name);
    }

    @Override
    @NbBundle.Messages({
        "GitHubCreatedByMeQuery.displayName=Created by me"
    })
    public String getDisplayName() {
        return Bundle.GitHubCreatedByMeQuery_displayName();
    }

    @Override
    protected Map<String, String> getFilter() {
        GitHubRepository gitHubRepository = getRepository();
        String userName = gitHubRepository.getUserName();
