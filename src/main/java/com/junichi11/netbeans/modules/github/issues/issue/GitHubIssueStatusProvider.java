 ...
 * @author junichi11
 */
public class GitHubIssueStatusProvider implements IssueStatusProvider<GitHubRepository, GitHubIssue> {
    ...
    @Override
    public Collection<GitHubIssue> getUnsubmittedIssues(GitHubRepository repository) {
        return Collections.emptyList();
    }

    @Override
    public void discardOutgoing(GitHubIssue issue) {
    }

    @Override
    public boolean submit(GitHubIssue issue) {
        // TODO
        return true;
    }
